...
class JobBoardNewModel extends Equatable {
  final String? id;
  final DateTime? jobDate;
  final DateTime? addedDate;

  final Area? jobArea;
  final AllServices? jobService;
  final String? bookingId;
  final Bookings? booking;
  final String? bookingServiceId;
  final BookingService? bookingService;
  final String? adminNote;
  final JobPriorityEnum? jobPriority;
  ...
  factory JobBoardNewModel.fromJson(Map<String, dynamic> json) =>
      JobBoardNewModel(
          id: json['id'],
          ...
          jobPriority: json['jobPriority'] != null
              ? EnumToString.fromString(
                  JobPriorityEnum.values, json['jobPriority'])
              : null,
          jobArea:
              json['jobArea'] != null ? Area.fromJson(json['jobArea']) : null,
          bookingService: json['bookingService'] != null
              ? BookingService.fromJson(json['bookingService'])
              : null,
          jobService: json['jobService'] != null
              ? AllServices.fromJson(json['jobService'])
              : null,
          booking: json['booking'] != null
              ? Bookings.fromJson(json['booking'])
              : null);
