                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () async {
                              FocusScope.of(context).unfocus();
                              print('_currWidgetIndex .... $_currWidgetIndex');
                                ...
                                //third page check
                                  ...
                                  if ((filledAcc && !invalidAcc) &&
                                    ...
                                    if (filledName &&
                                      ...
                                      } else if (registerResult.hasException) {
                                        showCustomDialog(
                                            'Oops!!',
      ...
      children: [
          ...
          child: Row(
            children: [
              SvgPicture.asset(
                ...
                color: checked ? zimkeyOrange : zimkeyDarkGrey.withOpacity(0.5),
              ),
              SizedBox(
                width: 5,
              ),
        ...
        Container(
          decoration: BoxDecoration(
            border: Border(
              bottom: BorderSide(
                color:
                    erroraAccnt ? zimkeyRed : zimkeyDarkGrey2.withOpacity(0.1),
              ),
            ),
          ),
          child: Row(
        ...
        Container(
          decoration: BoxDecoration(
            border: Border(
              bottom: BorderSide(
                color: errorIfsc ? zimkeyRed : zimkeyDarkGrey2.withOpacity(0.1),
              ),
            ),
          ),
          child: Row(
