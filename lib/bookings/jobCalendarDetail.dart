...
//Uncommit Job
                ...
                Hero(
                  ...
                  child: Material(
                    child: Container(
                      ...
                      child: detailBookingWidget(widget.jobitem!),
                    ),
                  ),
                ),
                SizedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      if (widget.jobitem!.bookingServiceItem!
                              ...
                              null &&
                          widget.jobitem!
                                  .bookingServiceItem!.bookingService!.service !=
                              null &&
                    ...
                    if (subBookings.startDateTime != null)
                      Row(
                        children: [
                          ...
                          Text(
                            '${subBookings.startDateTime!.day}-${subBookings.startDateTime!.month}-${subBookings.startDateTime!.year} | $hr:$min - $endHr:$endMin',
                            style: TextStyle(
                              fontSize: 12,
                              color: zimkeyDarkGrey,
                            ),
  ...
  Future<QueryResult> changeTeams(List<String> teams) async {
    final MutationOptions _options = MutationOptions(
      document: gql(changeTeam),
      variables: <String, dynamic>{
        "partnerCalendarId": widget.jobitem?.id,
        "teamIds": teams,
      },
    );
    setState(() {
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                widget.jobitem?.team == null ||
                        widget.jobitem?.team?.isEmpty == true
                    ? SizedBox()
                    : Row(
                ...
                widget.jobitem?.team == null ||
                    ...
                    : SizedBox(
                        ...
                        child: ListView.builder(
                            ...
                            itemCount: widget.jobitem?.team?.length,
                            itemBuilder: (context, index) => Container(
                                  ...
                                  child: Center(
                                      child: Text(
                                    widget.jobitem!.team![index].name,
                                    style: TextStyle(color: zimkeyOrange),
                                  )),
                                )),
                      ),
                SizedBox(
                  height: widget.jobitem?.team == null ? 0 : 10,
                ),
                Container(
          ...
          if (widget.jobitem!.bookingServiceItem!.reschedules != null &&
              widget.jobitem!.bookingServiceItem!.reschedules!.isNotEmpty)
            Container(
              padding: EdgeInsets.symmetric(
                horizontal: 10,
                vertical: 10,
              ...
              child: Column(
                ...
                children: [
                  ...
                  for (BookingServiceItemReschedules reschedules
                      in widget.jobitem!.bookingServiceItem!.reschedules!)
                    reschedulesItem(reschedules),
                ],
              ),
            ),
          //Subbookings--------
          if (widget.jobitem!.bookingServiceItem!.subBookings != null &&
              widget.jobitem!.bookingServiceItem!.subBookings!.isNotEmpty)
            Container(
              padding: EdgeInsets.symmetric(
                horizontal: 10,
                vertical: 10,
          ...
          if (reschedules.oldTime != null)
            Row(
              children: [
                ...
                Text(
                  '${reschedules.oldTime!.day}-${reschedules.oldTime!.month}-${reschedules.oldTime!.year} | $hr:$min - $endHr:$endMin',
                  style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.bold,
                    color: zimkeyDarkGrey.withOpacity(0.7),
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                fillColor: zimkeyOrange,
                                border: InputBorder.none,
                                hintText: 'Enter job verificiation code',
                                hintStyle: TextStyle(
                                  color: zimkeyDarkGrey.withOpacity(0.7),
                                  // fontWeight: FontWeight.bold,
                                  fontSize: 14,
                      ...
                      onTap: () async {
                        if (_workCode.text.isNotEmpty) {
                          ...
                          if (startJobResult.hasException) {
                            if (startJobResult.exception!.graphqlErrors !=
                                    null &&
                                startJobResult
                                    .exception!.graphqlErrors.isNotEmpty)
                              showCustomDialog(
