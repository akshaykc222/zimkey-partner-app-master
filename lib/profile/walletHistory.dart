                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                Text(
                                  partnerUser.partnerDetails!.walletBalance! > 0
                                ...
                                if (partnerUser.partnerDetails!.walletBalance! >
                                    0)
                                  InkWell(
                                    onTap: () {
                                      if (partnerUser
                      ...
                      if (walletLogs != null && walletLogs!.isNotEmpty)
                        for (PartnerWalletLog logItem in walletLogs!)
                          logItemWidget(logItem),
                      if (walletLogs == null ||
                          (walletLogs != null && walletLogs!.isEmpty))
                        Center(
                          child: Text(
                            'No transactions yet',
                            style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Transaction Date - ${DateTime.parse('${logItem.transactionDate}').day}-${DateTime.parse('${logItem.transactionDate}').month}-${DateTime.parse('${logItem.transactionDate}').year}',
            style: TextStyle(
              color: zimkeyDarkGrey,
              fontSize: 13,
            ),
